...
const CardSkeleton: React.FC<{}> = ({}) => {
  return (
    <div className="card shadow-sm cursor-pointer w-full p-5 duration-300 bg-white rounded-xl">
      ...
      <div className="font-bold text-blackDisplay rounded-full w-60 h-8 bg-gray-400 animate-pulse mb-2"></div>
      <div className="text-blackBody font-body font-regular mb-4 rounded-full w-40 h-6 bg-gray-400 animate-pulse"></div>
